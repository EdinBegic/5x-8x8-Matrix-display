...
class Max7219
{
       ...
       void pomocnaShiftKolone(int shift_poz, int& vrijednost, bool prviDisplej)
      {
        ...
        void popuniSveVektorePoKolonama(vector<uint8_t>&v4,vector<uint8_t>&v3,vector<uint8_t>&v2,vector<uint8_t>&v1,vector<uint8_t>&v0, int shift_poz, char znak)
        {
            ...
            for(int i=0;i<8;i++)            // Punimo sve redove odgovarajucim podacima
            {
                ...
                pomocnaShiftKolone(shift_poz,vrijednost4,true);
                pomocnaShiftKolone(shift_poz,vrijednost3,false);
                pomocnaShiftKolone(shift_poz,vrijednost2,false);
                pomocnaShiftKolone(shift_poz,vrijednost1,false);
                pomocnaShiftKolone(shift_poz,vrijednost0,false);
    ...
    public:
        ...
        void prikazVremena()
        {
            int protekloVrijeme = 1464283845; // http://www.epochconverter.com/
